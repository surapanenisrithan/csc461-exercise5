...
function setupShaders() {
    ...
    var vShaderCode = `
        ...
        void main(void) {
            vec2 newPosition = vertexPosition.xy;
            newPosition.x = newPosition.x * 2.0 - 0.5;
            newPosition.y = newPosition.y * 2.0 - 1.0;
            gl_Position = vec4(newPosition, vertexPosition.z, 1.0);
